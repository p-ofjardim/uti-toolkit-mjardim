/* ===== CÓDIGO JAVASCRIPT ===== */
        ...
        form.addEventListener('submit', function(event) {
            ...
            if (sodium < desiredSodium) {
                ...
                correctionText = `⚠️ Correção máxima recomendada: reduzir até ${maxCorrection} mEq/L nas primeiras 24 horas (${correctionPercentage.toFixed(1)}% do excesso total).`;
            } else {
