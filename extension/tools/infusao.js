...
const medicamentos = {
    ...
    dopamina: {
        ...
        doseUsual: '2-20',
        unidadeDose: 'mcg/kg/min',
        observacoes: 'Dose usual: 5-20 mcg/kg/min. Contraindicado em feocromocitom
a'
    },
    fentanil: {
        nome: 'Fentanil',
...
medicamentoSelect.addEventListener('change', function() {
    ...
    if (med && this.value !== 'outros') {
        ...
        // M
onta conteúdo com DOM (evita innerHTML dinâmico)
...
ase = concentracao; // U/mL
    ...
    co
nst goteiras = (taxaMLh * 20) / 60; // 1 mL = 20 goteiras
